...
namespace TestingRegex
{
    public class Tests
    {
        ...
        [Test]
        public void GivenValidateNumericPassword_WhenAnalysed_ShouldReturnValidateNumericPassword()
        {
            string expectedOutput = "Numeric Password is matching with Regex";
